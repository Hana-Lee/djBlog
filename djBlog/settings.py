...
ADMINS = (
    ('Hana Lee', 'voyaging.hana@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dBlog/db/djBlog.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '7bt6x8&nfkyi93uu0b^b89la*+)pi!0yzora#+z*cpgn6e1$03'
